...
<body ng-app="getAllFeedbacksApp" ng-controller="getAllFeedbacksCtrl">
	...
	<div class="content container">
		<h2><b>View/Delete Feedbacks</b></h2>
		<br>
		<div id="errorDiv"></div>
		<div id="tableDiv">
			<table class="table table-bordered table-striped" style="color: white;">
			  ...
			  <tbody>
			    <tr ng-repeat="feedback in feedbacks">
			      ...
			      <td><button class="closebtn btn btn-info" ng-click="deleteFeedback(feedback.id)">&times;</button></td>
			    </tr>
	<!-- 		    <tr>
			    	<td>2</td>
			    	<td>this is a good website</td>
			    	<td><span class="glyphicon glyphicon-star"></span><span class="glyphicon glyphicon-star" aria-hidden="true"></span><span class="glyphicon glyphicon-star" aria-hidden="true"><span class="glyphicon glyphicon-star" aria-hidden="true"></span></span></td>
			    ...
			    <tr>
			    	<td>4</td>
			    	<td>this is a good website</td>
			    	<td><span class="glyphicon glyphicon-star" aria-hidden="true"></span><span class="glyphicon glyphicon-star" aria-hidden="true"></span></td>
			    	<td><span class="closebtn">&times;</span></td>
			    </tr> -->		    
			  </tbody>
			</table>
	...
	?>
	<script src="js/jsFunctions/getAllFeedbacksFunctions.js"></script>
